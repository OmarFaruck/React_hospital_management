...
import img2 from '../../images/Our_Doctors/img3.png'
import '../SideCardBer/SideCardBer.css'
import Button from 'react-bootstrap/esm/Button';
export default function App() {
    return (
      <MDBCard style={{ maxWidth: '540px', marginBottom:'20px'}}  data-aos="fade-down-right">
        <MDBRow className='g-0'>
          ...
          <MDBCol md='8'>
            <MDBCardBody>
              <MDBCardTitle>Dr. A Aruna Prasad</MDBCardTitle>
              <MDBCardText>
