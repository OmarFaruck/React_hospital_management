...
import img2 from '../../images/Our_Doctors/img9.jpeg'
import '../SideCardBer/SideCardBer.css'
import Button from 'react-bootstrap/esm/Button';
export default function App() {
    return (
      <MDBCard style={{ maxWidth: '540px',marginBottom:'20px' }}  data-aos="zoom-in">
        <MDBRow className='g-0'>
          ...
          <MDBCol md='8'>
            <MDBCardBody>
              <MDBCardTitle>Dr. Achuth M Baliga</MDBCardTitle>
              <MDBCardText>
              HOD & Consultant - Dental Medicine
              </MDBCardText>
              <MDBCardText>
