    ...
    return (
        ...
        <div className="container-fluid">
           <div className="text-center"> 
               <h1  data-aos="zoom-in-up" className='RADIOLOGY' style={{color:'#16C2D5', fontFamily:'sans-serif', fontWeight:'bold', margin:'25px 0px'}}> <span style={{marginRight:'15px',color:'black' }}>RADIOLOGY</span>COURSES</h1> 
               <Row className='align-items-center'>
                  ...
                  <Col xs={12} sm={12} md={12} lg={6} xl={6} xxl={6}>
                  <h2 data-aos="zoom-in-down">MEDICAL LAB TECHNOLOGY COURSES</h2>
