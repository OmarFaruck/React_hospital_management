...
import img1 from '../../images/Hospitals/hospital_1.webp' 
import Button from 'react-bootstrap/esm/Button';
import '../HospitalCard/HospitalCard.css'

export default function App() {
    return (
      <MDBCard style={{ maxWidth: '540px',marginBottom:'20px'}} data-aos="zoom-in-right">
        <MDBRow className='g-0'>
          ...
          <MDBCol md='8'>
            <MDBCardBody>
              <MDBCardTitle className='text-center'>Old Airport Road - Bengaluru</MDBCardTitle>
